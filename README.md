 ...
 * การรันแล้วทำให้หน้าจอ console ยังคงแสดงผลค้างอยู่นั้น ให้เลือกเมนู Debug -> Start Without Debugging (Ctrl+F5) มิฉะนั้น หน้าจอ console จะหายไปอย่างรวดเร็ว
 ![](https://github.com/jaruwan2538/LAB-04/blob/master/imgs/Capture4.2.PNG?raw=true)
<hr>
<hr>
<hr>
<hr>
...
```
จากการทดลอง เมื่อใช้คำสั่ง Console.Write() เมื่อรันออกมา คำจะไม่เว้นบรรทัด ขึ้นบรรทัดใหม่
```
<hr>
<hr>
<hr>
...
![](https://github.com/jaruwan2538/LAB-04/blob/master/imgs/Capture4.3.PNG?raw=true)
<hr>
<hr>
<hr>
<hr>
 ...
 * สั่ง Run โปรแกรมและบันทึกผลที่ได้จากการรันโปรแกรม
 ![](https://github.com/jaruwan2538/LAB-04/blob/master/imgs/Capture4.4.PNG?raw=true)
<hr>
<hr>
<hr>
<hr>
...
ผลที่ได้จากการทดลอง เป็นอย่างที่นักศึกษาคิดหรือไม่ อย่างไร  จงอธิบาย
```
จากการทดลอง เมื่อใช้คำสั่ง Console.WriteLine()จะเพิ่มการขึ้นบรรทัดใหม่
```
<hr>
<hr>
<hr>
...
```
 ข้อแตกต่างของมันคือ เมธอด WriteLine() นั้นจะเพิ่มการขึ้นบรรทัดใหม่เข้าไปเพื่อคุณใส่ตัวอักษรเข้าไปในเมธอด ในขณะที่เมธอด Write() นั้นจะไม่ทำ 
 ```
<hr>
<hr>
<hr>
...
##สรุปผลการทดลอง
```
 Write() และ WriteLine() นั้นมาจากไลบรารี่มาตฐานของภาษา C# ซึ่งอยู่ในคลาส Console ข้อแตกต่างของมันคือ เมธอด WriteLine() นั้นจะเพิ่มการขึ้นบรรทัดใหม่เข้าไปเพื่อคุณใส่ตัวอักษรเข้าไปในเมธอด ในขณะที่เมธอด Write() นั้นจะไม่ทำ
 ```
<hr>
<hr>
<hr>
